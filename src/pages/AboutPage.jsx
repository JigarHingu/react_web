...
export default {
  ...
  'Redux Toolkit': {
  title: "Setting up Redux Toolkit",
  content: `Redux Toolkit is the official standard for React state management. It is installed alongside the 'react-redux' library, which connects it to your React components.`,
...
const ReduxIcon = () => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="#764ABC" d="M50 0A50 50 0 1050 100 50 50 0 1050 0zm24 63c-2 2-5 4-5 4l-5-5c-1-1-2-1-3 0l-15 15-15-15c-1-1-2-1-3 0l-5 5s-3-2-5-4c-2-2-4-5-4-5l15-15c1-1 2-1 3 0l5 5 5-5c1-1 2-1 3 0l15 15z"></path></svg>;
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-16">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4">
            ...
            <FeatureItem title="Memoization" icon={<FeatureIcons.Performance />} to="/posts/7">Prevents re-renders with `useMemo` and `React.memo`.</FeatureItem>
            <FeatureItem title="Global State Management" icon={<FeatureIcons.State />} to="/posts/8">
              Uses Redux Toolkit for robust, scalable, and centralized application state.
            </FeatureItem>
          </div>
        </div>
        ...
        <div className="bg-gray-800 text-white p-8 rounded-2xl shadow-xl">
          ...
          <div className="divide-y divide-gray-700">
            ...
            <TechItem name="Redux Toolkit" description="The official, recommended toolset for efficient Redux development." icon={<ReduxIcon />} onClick={() => setModalContent(techSetupInfo['Redux Toolkit'])} />
          </div>
        </div>
      </div>
